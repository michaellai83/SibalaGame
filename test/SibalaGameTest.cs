...
namespace SibalaGame_20240830.test
{
    public class SibalaGameTest
    {
        ...
        [Test]
        public void A12_Both_NormalPoint_White_Win()
        {
            var actual = _game.ShowResult("Black: 3 4 2 2  White: 6 3 1 3");
            actual.Should().Be("White win. - with normal point: 7");
        }

        [Test]
        public void A13_AllOfAKind_NormalPoint_Black_Win()
        {
            var actual = _game.ShowResult("Black: 5 5 5 5  White: 4 1 4 6");
            actual.Should().Be("Black win. - with all of a kind: 5");
        }

        [Test]
        public void A14_NormalPoint_AllOfAKind_White_Win()
        {
            var actual = _game.ShowResult("Black: 3 1 3 6  White: 2 2 2 2");
            actual.Should().Be("White win. - with all of a kind: 2");
        }

        [Test]
        public void A15_NormalPoint_NoPoint_Black_Win()
        {
        ...
        [Test]
        public void A17_Both_NoPoint_Tie()
        {
            var actual = _game.ShowResult("Black: 3 5 5 5  White: 6 3 1 4");
            actual.Should().Be("Tie.");
        }
    }
}